---
name: "m3-setup"
description: Sets up Material Design 3 Skills module in a project. Use when the user requests to 'install m3 module', 'configure Material Design 3 Skills', or 'setup Material Design 3 Skills'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/m3/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
uv run ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code m3
```
...
```bash
uv run ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code m3 --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
