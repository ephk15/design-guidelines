---
name: "hig-setup"
description: Sets up Apple HIG Skills module in a project. Use when the user requests to 'install hig module', 'configure Apple HIG Skills', or 'setup Apple HIG Skills'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/hig/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
uv run ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code hig
```
...
```bash
uv run ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code hig --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
